  ...
  const projects: Project[] = [
    {
      ...
      description: "Uma aplicação que ajuda o usuário a localizar e a explorar Food Trucks em San Francisco, um desafio criado pela Uber.",
  ...
  return (
    <div className="grid gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 p-2 sm:p-4">
      {projects.map((project, index) => (
        <Card key={index} className="bg-primary-foreground text-primary border-primary/20 flex flex-col">
          <CardHeader>
            <CardTitle className="text-lg sm:text-xl font-bold line-clamp-1">{project.title}</CardTitle>
