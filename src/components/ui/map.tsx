 ...
 * 
 * Note: This library is built on top of MapLibre GL JS. Most components extend 
 * the native MapLibre options. Refer to the MapLibre Map API for additional 
...
/**
 * A hook that provides access to the MapLibre map instance and loading state. 
 ...
 * - `map` (MapLibre.Map): The MapLibre map instance.
...
/**
 * The root container component that initializes MapLibre GL and provides context 
 * to child components. Automatically handles theme switching between light and dark modes.
 * 
...
type MapProps = {
  ...
  className?: string;
  /**
   * Theme for the map. If not provided, automatically detects from document class 
  ...
  /**
   * Controlled viewport state. When used with onViewportChange, enables controlled mode. 
   * Can also be used alone for initial viewport.
   */
  viewport?: Partial<MapViewport>;
  /**
   * Callback fired continuously as the viewport changes (during pan, zoom, rotate). 
   * Can be used alone to observe changes, or with viewport prop to enable controlled mode.
   */
...
const Mapcn = forwardRef<MapRef, MapProps>(function Mapcn(
  {
    children,
    className,
    theme: themeProp,
...
/**
 * A container for marker-related components. Provides context for its children 
 * and handles marker positioning.
 * 
...
/**
 * Renders the visual content of a marker. Must be used inside MapMarker. 
 ...
 * 
 * Note: The className and closeButton from MapLibre's PopupOptions are excluded 
 * to prevent style conflicts. Use the component's own props to style the popup.
 */
 ...
 * 
 * Extends PopupOptions from MapLibre GL (excluding className, closeButton, and 
 * closeOnClick as tooltips auto-dismiss on hover out).
 * 
 * Note: The className from MapLibre's PopupOptions is excluded to prevent style 
 * conflicts. Use the component's own className prop to style the tooltip content.
 */
 ...
 * without a marker. Must be used inside Map.
 * 
 * Extends PopupOptions from MapLibre GL (excluding className and closeButton).
 * 
 * Note: The className and closeButton from MapLibre's PopupOptions are excluded 
 ...
 * Automatically groups nearby points into clusters that expand on click. 
 * Must be used inside Map. Supports a generic type parameter for typed 
 * feature properties: `MapClusterLayer<MyProperties>`.
 */
